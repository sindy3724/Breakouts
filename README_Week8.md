...
Output Layer – Uses softmax or another function to give final results
...
ROC-AUC (Receiver Operating Characteristic - Area Under Curve): Evaluates how well the classifier separates positive and negative classes.
